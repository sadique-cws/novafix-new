...
@php
    ...
    $baseClasses = 'inline-flex items-center justify-center font-medium rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-2 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed';
    ...
    $variantClasses = match($variant) {
        ...
        'ghost' => 'bg-transparent shadow-none text-gray-600 hover:text-gray-900 hover:bg-gray-100 focus:ring-gray-500',
