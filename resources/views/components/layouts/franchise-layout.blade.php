    ...
    <div class="flex gap-1">
        ...
        <div class="fixed top-0 left-0 h-screen w-64 bg-gray-900 border-r border-gray-800 z-50 transform transition-transform duration-300 flex flex-col"
            ...
            <div class="pt-4 pb-4 px-4 border-b border-gray-800 flex items-center justify-start gap-3">
                ...
                <h2 class="text-base font-medium md:text-lg text-white truncate max-w-[150px]">
                    {{Auth::guard('franchise')->user()->franchise_name ?? 'Franchise'}}</h2>
                <button @click="isMobileSidebarOpen = false"
                    class="lg:hidden ml-auto text-gray-500 hover:text-gray-300">
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <div class="relative" x-data="{ open: false }">
                        <button @click="open = !open" @click.outside="open = false"
                            ...
                            <span
                                class="hidden md:block text-sm font-medium text-gray-300">{{Auth::guard('franchise')->user()->franchise_name ?? 'Franchise'}}</span>
                            <img src="https://ui-avatars.com/api/?name=Franchise&background=1E40AF&color=fff"
                                alt="User profile" class="w-9 h-9 rounded-full object-cover border-2 border-gray-700">
                        ...
                        <div x-show="open" x-transition x-cloak
                            ...
                            <a href="{{ route('franchise.profile') }}" wire:navigate
