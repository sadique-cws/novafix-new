    ...
    <div class="flex gap-1">
        ...
        <div class="fixed top-0 left-0 h-screen w-64 bg-gray-900 border-r border-gray-800 z-50 transform transition-transform duration-300 flex flex-col"
            ...
            <div class="pt-4 pb-4 px-4 border-b border-gray-800 flex items-center justify-start gap-3">
                ...
                <h2 class="text-base font-medium md:text-lg text-white">Staff Panel</h2>
                ...
                <ul>
                    <li class="mb-1">
                        <a wire:navigate href="{{ route('staff.dashboard') }}" 
                              class="flex items-center font-medium p-3 rounded-lg {{ request()->routeIs('staff.dashboard') ? 'bg-gray-800 text-white' : 'text-gray-300 hover:bg-gray-800 hover:text-white transition-colors' }}">
                    ...
                    <li class="mb-1">
                        <a wire:navigate href="{{ route('staff.novafix-diagnosis') }}" 
                              class="flex items-center font-medium p-3 rounded-lg {{ request()->routeIs('staff.novafix-diagnosis') ? 'bg-gray-800 text-white' : 'text-gray-300 hover:bg-gray-800 hover:text-white transition-colors' }}">
                    ...
                    <li class="mb-1">
                        <a href="{{ route('staff.assigned.task') }}" 
                              class="flex items-center font-medium p-3 rounded-lg {{ request()->routeIs('staff.assigned.task') ? 'bg-gray-800 text-white' : 'text-gray-300 hover:bg-gray-800 hover:text-white transition-colors' }}">
                    ...
                    <li class="mb-1">
                        <a href="{{ route('staff.completed.task') }}" 
                              class="flex items-center font-medium p-3 rounded-lg {{ request()->routeIs('staff.completed.task') ? 'bg-gray-800 text-white' : 'text-gray-300 hover:bg-gray-800 hover:text-white transition-colors' }}">
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <div class="relative" x-data="{ open: false }">
                        <button @click="open = !open" @click.outside="open = false" class="flex items-center space-x-3 focus:outline-none">
                            <span class="hidden md:block text-sm font-medium text-gray-300">Staff Profile</span>
                            <img src="https://ui-avatars.com/api/?name=Staff&background=1E40AF&color=fff" alt="User profile" class="w-9 h-9 rounded-full object-cover border-2 border-gray-700">
                        ...
                        <div x-show="open" x-transition x-cloak
                            ...
                            <a href="{{ route('staff.profile') }}" wire:navigate class="flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 hover:text-primary transition-colors">
