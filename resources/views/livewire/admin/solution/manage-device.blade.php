<!-- livewire/admin/solution/manage-device.blade.php -->
<div>
        ...
        <div class="flex flex-col lg:flex-row gap-6 items-start">
            ...
            <div class="w-full lg:w-1/3">
                <div class="bg-white rounded-xl shadow-2xs border border-slate-200 overflow-hidden">
                    ...
                    <form class="p-5 space-y-4" wire:submit.prevent="{{ $editingId ? 'updateDevice' : 'addDevice' }}">
                        <div class="space-y-1.5">
                            <label class="block text-xs font-semibold text-slate-700">Device Name <span class="text-rose-500">*</span></label>
                            <input type="text" wire:model="name" placeholder="e.g. Smartphone, Laptop, Tablet"
            ...
            <div class="w-full lg:w-2/3">
                <div class="bg-white rounded-xl shadow-2xs border border-slate-200 overflow-hidden">
                    ...
                    <div class="bg-slate-50 px-5 py-3.5 border-b border-slate-200 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                        <div class="flex items-center gap-2">
                            <h2 class="text-sm font-bold text-slate-800">Manage Devices</h2>
                    ...
                    <div class="overflow-x-auto">
                        <table class="min-w-full border-collapse">
                            ...
                            <tbody class="bg-white">
                                    ...
                                    <tr class="border-b border-slate-200 hover:bg-blue-50/30 transition-colors">
                                        ...
                                        <td class="px-5 py-3.5 whitespace-nowrap border-b border-slate-200">
                                            <div class="flex items-center gap-2">
                                                ...
                                                <span class="text-xs sm:text-sm font-semibold text-slate-900">{{ $device->name }}</span>
                                            </div>
                                        </td>
                                        <td class="px-5 py-3.5 whitespace-nowrap text-right border-b border-slate-200">
                                            <div class="flex items-center justify-end gap-1">
                                                ...
                                                <button wire:click="$dispatch('openConfirmDeleteModal', { id: {{ $device->id }}})"
                                                    title="Delete Device"
                                ...
                                @empty
                                    <tr>
                                        <td colspan="3" class="px-6 py-12 text-center border-b border-slate-200">
                                            <div class="max-w-sm mx-auto space-y-2">
                                                ...
                                                <p class="text-sm font-semibold text-slate-700">No devices found</p>
                                                <p class="text-xs text-slate-400">Try adjusting your search query or add a new device using the form.</p>
                                            </div>
                                        </td>
                                    </tr>
                                @endforelse
