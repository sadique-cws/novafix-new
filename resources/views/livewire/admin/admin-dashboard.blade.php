                ...
                <div class="overflow-x-auto">
                    ...
                    <div class="block sm:hidden space-y-4">
                        @forelse($franchises as $franchise)
                            <div class="bg-gray-50 p-4 rounded-lg shadow-sm">
                                ...
                                <p class="text-xs text-gray-900 mt-2">₹{{ number_format($franchise->monthly_revenue, 2) }} <span class="text-gray-500">This month</span></p>
                                <p class="text-xs text-{{ $franchise->growth >= 0 ? 'green' : 'red' }}-600 font-medium mt-2">
                                    {{ $franchise->growth >= 0 ? '+' : '' }}{{ $franchise->growth }}%
                                </p>
                    ...
                    <table class="min-w-full divide-y divide-gray-200 hidden sm:table">
                        <thead class="bg-gray-50">
                            <tr>
                                <th scope="col" class="px-4 sm:px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider cursor-pointer" wire:click="sortBy('franchise_name')">
                                    Franchise
                                ...
                                <th scope="col" class="px-4 sm:px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider cursor-pointer" wire:click="sortBy('status')">
                                    Status
                                    @if ($sortField === 'status')
                                        <i class="fas fa-sort-{{ $sortDirection === 'asc' ? 'up' : 'down' }} ml-1"></i>
                                    @else
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            @forelse($franchises as $franchise)
                                <tr>
                                    ...
                                    <td class="px-4 sm:px-6 py-4 whitespace-nowrap">
                                        <div class="text-xs sm:text-sm text-gray-900">₹{{ number_format($franchise->monthly_revenue, 2) }}</div>
