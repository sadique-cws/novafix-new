        ...
        @if ($franchise)
            ...
            <div class="bg-white shadow-lg rounded-xl overflow-hidden mb-8">
                <div class="bg-gray-50 px-6 py-4 border-b border-gray-200 flex justify-between items-center">
                    <div class="flex items-center">
                        <div
                            class="flex-shrink-0 h-12 w-12 rounded-full bg-blue-100 flex items-center justify-center mr-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="bg-white shadow rounded-lg p-6">
                    <h2 class="text-lg font-semibold text-gray-800 mb-4 pb-2 border-b border-gray-200">Basic Information
                    </h2>
                    <div class="space-y-4">
                        <div>
                ...
                <div class="bg-white shadow rounded-lg p-6">
                    <h2 class="text-lg font-semibold text-gray-800 mb-4 pb-2 border-b border-gray-200">Address
                        Information</h2>
                    <div class="space-y-4">
                        <div>
                ...
                <div class="bg-white shadow rounded-lg p-6">
                    <h2 class="text-lg font-semibold text-gray-800 mb-4 pb-2 border-b border-gray-200">Financial
                        Information</h2>
                    <div class="space-y-4">
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                ...
                <div class="bg-white shadow rounded-lg p-6">
                    <h2 class="text-lg font-semibold text-gray-800 mb-4 pb-2 border-b border-gray-200">System
                        Information</h2>
                    <div class="space-y-4">
                        <div>
                        ...
                        @if ($franchise->deleted_at)
                            <div>
                                ...
                                <p class="mt-1 text-gray-900">{{ $franchise->deleted_at->format('M d, Y \a\t h:i A') }}
                                </p>
                            </div>
                        @endif
                    </div>
            ...
            <div class="mt-6 flex justify-end space-x-3">
                <a wire:navigate href="{{ route('admin.manage-franchises') }}"
                    class="px-4 py-2 bg-[#1E40AF] text-white rounded-md hover:bg-[#1E3A8A] transition duration-150 ease-in-out flex items-center focus:outline-none focus:ring-2 focus:ring-[#1E40AF] focus:ring-opacity-50">
