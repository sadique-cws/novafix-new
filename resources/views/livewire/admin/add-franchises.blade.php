                    ...
                    <form wire:submit.prevent="submit" class="px-8 mt-5 pb-8">
                        ...
                        <div class="mb-10">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        <input wire:model.live="contact_no" maxlength="10" type="tel"
                                            id="contact_no" autocomplete="off"
                                            class="block w-full rounded-lg border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm border py-3 px-4 transition duration-150 ease-in-out"
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    <label for="aadhar_no" class="block text-sm font-medium text-gray-700 mb-2">Aadhar
                                        Number</label>
                                    <div class="relative">
                                        <input wire:model.live="aadhar_no" type="text" id="aadhar_no"
                                            autocomplete="off"
                                            class="block w-full rounded-lg border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm border py-3 px-4 transition duration-150 ease-in-out"
                                ...
                                <div>
                                    <label for="pan_no" class="block text-sm font-medium text-gray-700 mb-2">PAN
                                        Number</label>
                                    <div class="relative">
                                        <input wire:model.live="pan_no" type="text" id="pan_no"
                                            autocomplete="off"
                                            class="block w-full rounded-lg border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm border py-3 px-4 transition duration-150 ease-in-out"
                                ...
                                <div>
                                    <label for="bank_name" class="block text-sm font-medium text-gray-700 mb-2">Bank
                                        Name</label>
                                    <div class="relative">
                                        <input wire:model.live="bank_name" type="text" id="bank_name"
                                            autocomplete="off"
                                            class="block w-full rounded-lg border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm border py-3 px-4 transition duration-150 ease-in-out"
                                    ...
                                    <div class="relative">
                                        ...
                                        <div
                                            ...
                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-gray-400"
                                                fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                <path stroke-linecap="round" stroke-linejoin="round"
                                                    stroke-width="1.5" d="M4 6h16M4 10h16M4 14h16M4 18h16" />
                                            </svg>
                                        </div>
                                    </div>
                                    @error('account_no')
                        ...
                        <div class="mb-10">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    <label for="street"
                                        class="block text-sm font-medium text-gray-700 mb-2">Street Address</label>
                                    <div class="relative">
