    ...
    <div class="container   px-4 sm:px-6 lg:px-8 py-6">
        <div class=" overflow-hidden">
            ...
            @if (session()->has('message'))
                <div class="mx-4 sm:mx-6 mt-4 px-4 py-3 bg-green-50 text-green-700 rounded-lg border border-green-100 text-sm sm:text-base animate-slide-in">
                    {{ session('message') }}
                </div>
            @endif
            ...
            <div class="sm:hidden p-4 space-y-4">
                @forelse ($franchises as $franchise)
                    <div class="bg-white p-4 rounded-xl shadow-md border border-gray-100 hover:shadow-lg transition-all duration-200">
                        <div class="flex items-start justify-between">
                            <div class="flex items-center gap-3">
                                <div class="flex-shrink-0 h-10 w-10 rounded-full bg-gradient-to-br from-blue-500 to-indigo-600 flex items-center justify-center">
                                    <span class="text-white font-semibold text-base">{{ substr($franchise->franchise_name, 0, 1) }}</span>
                                </div>
                                <div>
                            ...
                            <span class="status-badge {{ $franchise->status === 'active' ? 'status-active' : ($franchise->status === 'inactive' ? 'status-inactive' : 'status-pending') }}">
                        ...
                        <div class="mt-4 flex justify-end space-x-3">
                            <button wire:click="edit({{ $franchise->id }})" class="text-blue-600 hover:text-blue-800 flex items-center text-sm font-medium transition-colors duration-200">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-1.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
                                </svg>
                                Edit
                            </button>
                            <a wire:navigate href="{{ route('admin.view-franchises', $franchise->id) }}" class="text-green-600 hover:text-green-800 flex items-center text-sm font-medium transition-colors duration-200">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-1.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div class="hidden sm:block overflow-x-auto">
                <table class="min-w-full divide-y divide-gray-200">
                    <thead class="bg-gray-50">
                        <tr>
                            <th scope="col" class="px-6 py-4 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider cursor-pointer hover:bg-gray-100 transition-colors duration-200" wire:click="sortBy('franchise_name')">
                            ...
                            <th scope="col" class="px-6 py-4 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider cursor-pointer hover:bg-gray-100 transition-colors duration-200" wire:click="sortBy('email')">
                                <div class="flex items-center gap-2">
                                    <span>Email</span>
                                    <svg class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                            ...
                            <th scope="col" class="px-6 py-4 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider cursor-pointer hover:bg-gray-100 transition-colors duration-200" wire:click="sortBy('status')">
                                <div class="flex items-center gap-2">
                                    <span>Status</span>
                                    <svg class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
