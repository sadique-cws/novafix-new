  ...
  <div class=" overflow-hidden">
    ...
    <div class="sm:hidden p-4 space-y-4">
      @forelse ($franchises as $franchise)
        <div
          class="bg-white p-4 rounded-xl shadow-md border border-gray-100 hover:shadow-lg transition-colors duration-200">
          ...
          <div class="mt-4 flex justify-end space-x-3">
            ...
            <a wire:navigate href="{{ route('admin.franchise-service-requests', $franchise->id) }}"
              class="text-indigo-600 hover:text-indigo-800 flex items-center text-sm font-medium transition-colors duration-200">
