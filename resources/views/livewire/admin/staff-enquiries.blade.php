                    ...
                    <div class="bg-gray-50 px-6 py-3.5 border-t border-gray-200 flex items-center justify-between">
                        <button type="button"
                            @click="$dispatch('confirm-action', {
                                title: 'Delete Staff Enquiry',
                                message: 'Are you sure you want to delete this enquiry from {{ addslashes($selectedEnquiry->staff->name ?? 'Staff') }}? This action cannot be undone.',
