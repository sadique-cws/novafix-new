    ...
    <div class="bg-white rounded-xl shadow-sm overflow-hidden">
        ...
        <div class="px-6 py-5 border-b border-gray-200 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            ...
            <button wire:click="$dispatch('startAdd')"
                class="inline-flex items-center px-4 py-2.5 bg-indigo-600 hover:bg-indigo-700 text-white rounded-lg font-medium shadow-sm transition-colors duration-200">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                        <div class="flex justify-end space-x-2">
                                            <button wire:click="startEdit({{ $category->id }})" 
                                                    class="inline-flex items-center px-3 py-1.5 border border-transparent text-sm font-medium rounded-md text-indigo-700 bg-indigo-100 hover:bg-indigo-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition-colors">
                                            ...
                                            <button wire:click="confirmDelete({{ $category->id }})" 
                                                    class="inline-flex items-center px-3 py-1.5 border border-transparent text-sm font-medium rounded-md text-red-700 bg-red-100 hover:bg-red-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 transition-colors">
                                                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-1" viewBox="0 0 20 20" fill="currentColor">
                            ...
                            @empty
                                <tr>
                                    <td colspan="3" class="px-6 py-8 text-center">
                                        ...
                                        <h3 class="mt-2 text-sm font-medium text-gray-900">No service categories found</h3>
                                        <p class="mt-1 text-sm text-gray-500">Get started by adding a new service category.</p>
                                        <div class="mt-6">
                                            <button wire:click="$dispatch('startAdd')"
