        ...
        <div class="card stat-card bg-white rounded-lg shadow p-4 sm:p-6">
            <div class="flex items-center">
                ...
                <div>
                    ...
                    <h3 class="text-2xl font-bold">₹{{ number_format($stats['totalRevenue'], 2) }}</h3>
                </div>
            </div>
            <div class="mt-4">
                <p class="text-sm text-green-500 font-medium">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 mb-6">
        ...
        <div class="card bg-white rounded-lg shadow p-4 sm:p-6">
            <div class="flex justify-between items-center mb-4">
                ...
                <select 
                    wire:model="performanceFilter" 
                    wire:change="updatePerformanceFilter($event.target.value)"
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6">
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr>
                            ...
                            <td class="px-4 sm:px-6 py-4 whitespace-nowrap text-sm text-gray-500">{{ $order['customer'] }}</td>
                            <td class="px-4 sm:px-6 py-4 whitespace-nowrap text-sm text-gray-500">{{ $order['service'] }}</td>
                            <td class="px-4 sm:px-6 py-4 whitespace-nowrap text-sm">
                                <span class="px-2 py-1 text-xs rounded-full {{ $order['status']['class'] }}">{{ $order['status']['text'] }}</span>
                            </td>
                            <td class="px-4 sm:px-6 py-4 whitespace-nowrap text-sm text-gray-500">${{ number_format($order['amount'], 2) }}</td>
                        </tr>
                        @endforeach
                    </tbody>
                </table>
        ...
        <div class="card bg-white rounded-lg shadow p-4 sm:p-6">
            ...
            <div class="space-y-3 sm:space-y-4">
                <a wire:navigate href="{{ route('franchise.add.staff') }}" class="block w-full flex items-center justify-between p-3 sm:p-4 bg-blue-50 text-blue-600 rounded-lg hover:bg-blue-100">
                    <span>Add New Staff</span>
                    <i class="fas fa-user-plus"></i>
                </a>
                <a href="" class="block w-full flex items-center justify-between p-3 sm:p-4 bg-green-50 text-green-600 rounded-lg hover:bg-green-100">
                    <span>Create Invoice</span>
                    <i class="fas fa-file-invoice"></i>
                </a>
                <a href="" class="block w-full flex items-center justify-between p-3 sm:p-4 bg-purple-50 text-purple-600 rounded-lg hover:bg-purple-100">
                    <span>Schedule Service</span>
                    <i class="fas fa-calendar-alt"></i>
                </a>
                <a href="" class="block w-full flex items-center justify-between p-3 sm:p-4 bg-orange-50 text-orange-600 rounded-lg hover:bg-orange-100">
