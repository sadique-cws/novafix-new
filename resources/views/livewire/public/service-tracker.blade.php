        ...
        @if ($serviceRequest)
            <div class="bg-white rounded-xl border border-gray-200 p-8">
                <div class="flex justify-between items-center mb-6">
                    ...
                    <a wire:navigate href="{{route('receipt.view', $serviceRequest->service_code)}}" class="px-4 py-2 bg-green-600 text-white rounded-md hover:bg-green-700 transition-colors flex items-center">
