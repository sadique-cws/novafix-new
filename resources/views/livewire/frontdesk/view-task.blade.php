<div class="max-w-7xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8 py-4 sm:py-6 md:py-8">
        ...
        <div class="space-y-4 sm:space-y-6">
                    ...
                    @if (!$paymentCompleted && !$taskRejected)
                                ...
                                <div class="space-y-3 sm:space-y-4">
                                    ...
                                    <div class="flex space-x-2 sm:space-x-3">
                                        <button wire:click="completeWithPayment"
                                            class="flex-1 bg-indigo-600 text-white py-2 rounded-lg hover:bg-indigo-700 transition-all duration-200 transform hover:scale-105">Pay
                                            Now</button>
                        ...
                        <div class="mt-4 sm:mt-6">
                            ...
                            <div class="relative mt-1">
                                ...
                                <i
                                    class="fas fa-chevron-down absolute right-3 top-1/2 transform -translate-y-1/2 text-gray-600 text-sm"></i>
                            </div>
                        </div>
                    @elseif($taskRejected)
            ...
            @if ($showOtpModal)
                <div class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 px-3 sm:px-0">
                    <div
                        class="bg-white rounded-lg p-4 sm:p-6 w-full max-w-sm sm:max-w-md transform transition-all duration-300">
                        ...
                        <div class="mb-3 sm:mb-4">
                            ...
                            <input type="text" wire:model="otp"
                                class="w-full px-3 py-2 text-sm border rounded-md focus:ring-indigo-500 focus:border-indigo-500 transition-all duration-200"
    ...
    @if ($showRejectionModal)
        <div class="fixed inset-0 bg-gray-600 bg-opacity-50 flex items-center justify-center z-50 px-3 sm:px-0">
            <div
                class="bg-white rounded-xl shadow-xl max-w-sm sm:max-w-lg w-full p-4 sm:p-6 transform transition-all duration-300">
                <div class="flex items-start">
                ...
                <div class="mt-4 sm:mt-6 flex flex-col sm:flex-row justify-end gap-2 sm:gap-3">
                    <button wire:click="confirmRejection"
                        class="w-full sm:w-auto px-3 sm:px-4 py-2 bg-red-600 text-white rounded-lg hover:bg-red-700 transition-all duration-200 transform hover:scale-105">Confirm
                        Rejection</button>
