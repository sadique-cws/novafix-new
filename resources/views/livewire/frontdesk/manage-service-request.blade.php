    ...
    <div class="sticky top-0 z-20 bg-gradient-to-r from-gray-50 to-gray-100 pb-4 pt-2 backdrop-blur-sm">
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            ...
            <div class="flex items-center space-x-3">
                <a wire:naigate href="{{ route('frontdesk.servicerequest.create') }}"
                    class="flex items-center space-x-2 bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg transition-all duration-200 shadow-md hover:shadow-lg">
        ...
        <div class="mt-6 grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div class="relative">
                ...
                <input type="text" wire:model.live.debounce.300ms="search" placeholder="Search requests..."
                ...
                @forelse($requests as $request)
                    <tr class="hover:bg-gray-50 transition-colors duration-150">
                        <td class=" px-6 py-4 whitespace-nowrap">
                            <div class="flex items-center">
                                <div
                                    class="flex-shrink-0 h-10 w-10 bg-blue-50 rounded-lg flex items-center justify-center">{{$request->id}}
                                </div>
                                <div class="ml-4">
                        ...
                        <td class=" px-6 py-4 whitespace-nowrap">
                            @if ($request->technician_id)
                                <div class="flex items-center">
                                    <div
                                        class="flex-shrink-0 h-8 w-8 rounded-full bg-indigo-100 flex ite px-ms-center justify-center">
                                        <span
                            ...
                            @else
                                <select wire:change="assignTechnician('{{ $request->id }}', $event.target.value)"
                                    class="text-xs border border-gray-300 rounded-md px-3 py-1.5 focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white shadow-sm transition-all duration-200">
                        ...
                        <td class="w-32 px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                            <div class="flex justify-end space-x-2">
                                ...
                                <a href="{{ route('franchise.edit.servicerequest', $request->id) }}"
                    ...
                    <tr>
                        <td colspan="6" class="px-6 py-4 text-center">
                            <div class="flex flex-col items-center justify-center py-8">
                                ...
                                <h3 class="mt-2 text-sm font-medium text-gray-900">No service requests found
                                </h3>
            ...
            <div
                ...
                <div class="p-4">
                    ...
                    <div class="mt-3 flex items-center justify-between">
                        ...
                        @else
                            <select wire:change="assignTechnician('{{ $request->id }}', $event.target.value)"
                                class="text-xs border border-gray-300 rounded-md px-2 py-1 focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white shadow-sm">
